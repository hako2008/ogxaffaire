...
})(window,document,'script','dataLayer','GTM-KK8BKGB');</script>
<!-- End Google Tag Manager -->
<meta name="keywords" content="keyword search,recherche par mot clé,بحث بكلمة مفتاحية,{{$keyword->name}},{{trans('messages.headermetakeyword')}}" />
...
@if (isset($id))
        ...
        <hgroup class="mb20 animated-headline-v1 text-left color-black">
          ...
          <h1 class="animated-headline-title letters type color-black">
            {{ trans('messages.searchresults') }}<span class="color-base"> {{ trans('messages.keyword') }}: </span>
