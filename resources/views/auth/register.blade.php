...
<meta property="og:title" content="{{ trans('messages.register') }}-{{ config('app.name', 'Laravel') }}" />
...
<title>{{ trans('messages.register') }}-{{ config('app.name', 'Laravel') }}</title>
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            <label for="name" class="col-md-4 control-label">{{ trans('messages.fullname') }}</label>
